...
import {WHATSAPP, EMAIL, COMPANY, PHONE} from "../lib/siteConfig";
...
export default function HomeCard({
    ...
    return (
        ...
        >
            ...
            <div
                style={s(
                    "display:flex; align-items:center; justify-content:flex-end; animation:risein 0.6s ease 0.05s both;",
                )}
            >
                <div
                    style={s(
                        "display:inline-flex; align-items:center; gap:7px; padding:7px 14px 7px 10px; border-radius:999px; background:linear-gradient(135deg, rgba(63,191,143,0.28) 0%, rgba(46,143,138,0.22) 100%); border:1px solid rgba(159,201,197,0.35); font-size:11px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:#DFF3EE;",
                    )}
                >
          <span
              style={s(
          ...
          />
            ...
            <div style={s("margin-top:4px; animation:risein 0.6s ease 0.12s both;")}>
                ...
                >
                    Tatort-, Leichenfund- & Messie-Reinigung
                </h1>
                <p
                    style={s(
            ...
            <Hover
                as="a"
                href={"tel:" + PHONE}
                base="display:flex; align-items:center; justify-content:center; gap:9px; text-decoration:none; padding:15px; border-radius:15px; background:linear-gradient(180deg,#22996A 0%,#1E8A5F 100%); box-shadow:0 10px 24px rgba(30,138,95,0.4); color:#fff; font-size:15px; font-weight:700; transition:filter .16s ease; animation:risein 0.6s ease 0.2s both;"
          ...
          >
            ...
            >
                ...
                <input
                    ...
                    style={s(
                        "flex:1; border:none; outline:none; background:transparent; font-family:var(--font-sans),sans-serif; font-size:16px; color:#fff; min-width:0;",
                    )}
                />
                <Hover
                    as="button"
